...
import com.android2ee.formation.service.helper1.generic.honeycomb.MFragment;
...
public abstract class MActivityHC extends Activity {
	...
	private BroadcastReceiver serviceCallBackReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction() == getActivityId()) {
				...
				for (MFragment mFrag : listeningFragments) {
	 ...
	 */
	List<MFragment> listeningFragments = new ArrayList<MFragment>();

	/**
	 * This method is called by the MFragment to be register as a broadcast receiever of the intent
	 * 
	 * @param fragment
	 *            The fragment for registration
	 */
	void addMFragment(MFragment fragment) {
	...
	/**
	 * This method is called by the MFragment to be unregister as a broadcast receiever of the intent
	 * 
	 * @param fragment
	 */
	void removeMFragment(MFragment fragment) {
		// add the fragment to the list of listening fragments
